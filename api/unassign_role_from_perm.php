<?php
//    File: unassign_role_from_perm.php
//
//Revision:2014091001
//
//
...
if($rbac->Permissions->unassign($TITLE, $P_ID)) {	// or $rbac->Roles->unassign(), what a mess...
	$RESULT = "OK.";
	
	$P_ID = preg_match("/^[0-9]+$/", $P_ID) == 1 ? $P_ID : $rbac->Roles->titleID($P_ID);
